...
python3 main.py --base configs/stable-diffusion/v1-finetune-lasr.yaml -t --actual_resume models/stable-diffusion-v-1-4-original/sd-v1-4-full-ema.ckpt -n corgi-lasr --gpus $GPU, --data_root data_unused/corgi/ --placeholder_string "y" --no-test  --init_word "corgi dog" --init_word_weights 2 1
