...
def parse_args():
    ...
    parser.add_argument("--zs_arc2face_inverse_prompt_embs_inf_type", type=str, default='full_zeroed_extra',
                        choices=['full_zeroed_extra', 'full', 'full_avg_pad', 'full_half_pad', 'full_pad', 'b_core_e'],
