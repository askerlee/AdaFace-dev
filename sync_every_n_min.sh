...
fish -c "rsync2 172.20.117.176,172.20.117.112 -avKL --exclude='*-db/' --exclude='*png' --exclude='*/embeddings.pt' --info=progress2 /home/lish/adaprompt/logs/ shaohua@SERVER:adaprompt/logs/"
