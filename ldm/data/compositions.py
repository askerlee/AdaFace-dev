...
[ "doing (makeup|housekeeping|gardening|exercise)",
  "carrying a (bag|backpack|book|briefcase|bouquet|baby|cat|dog|teddy bear)",
  ...
  "sitting (in a chair|on a bench|in a couch|in a wheelchair)",
  "swimming (in a pool|underwater|in the ocean|in a lake|in a river)( among tropical fishes)",
  "pushing a (car|wheelchair|stroller|bicycle|motorcycle|scooter)",
  ...
  "playing (a piano|a violin|basketball|tennis)",
  "riding a (bike|motorcycle|scooter|horse|boat)",
