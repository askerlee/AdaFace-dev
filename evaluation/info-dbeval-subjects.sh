...
set -g db_prompts     "red backpack"    "cute backpack"      "stuffed animal"  "berry bowl"    can           "glass candle"  cat             cat             "yellow clock"   sneaker           dog          dog             dog              dog          dog               dog             dog             toy             boot            "stuffed animal"        "monster toy"   glasses         toy             "toy car"       "cartoon sprite"   toy             sneaker         "chinese teapot"  "stylish vase"        "stuffed animal"
set -g cls_tokens     backpack          backpack             toy               bowl            can           candle          cat             cat             clock            sneaker           dog          dog             dog              dog          dog               dog             dog             toy             boot            toy                     toy             glasses         toy             toy             sprite             toy             sneaker         teapot            vase                  toy             
...
set -g ada_prompts    "red backpack"    "cute backpack"      "stuffed toy"     "berry bowl"    can           "glass candle"  cat             cat             "yellow clock"   sneaker           dog          dog             dog              dog          dog               dog             dog             toy             boot            "stuffed toy"           "monster toy"   glasses         toy             "toy car"       "cartoon sprite"  toy              sneaker         "chinese teapot"  "stylish vase"        "stuffed toy"
...
set -g misc_train_opts     --use_fp_trick 0  --subj_attn_norm_distill_loss_base 2e-4
