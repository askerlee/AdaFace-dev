...
set -g cls_delta_strings    "red backpack"     "cute backpack"      "stuffed toy"     "berry bowl"    can           "glass candle"  cat             cat             "yellow clock"   sneaker           dog          dog             dog              dog          dog               dog             dog             toy             boot            "stuffed toy"           "monster toy"   glasses         toy             "toy car"       "cartoon sprite"  toy              sneaker         "chinese teapot"  "stylish vase"        "stuffed toy"
